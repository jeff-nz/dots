...
alias my-dd='sudo dd bs=1M status=progress'
alias my-explore='nautilus --no-desktop &'
alias my-ip="ifconfig | sed -En 's/127.0.0.1//;s/.*inet (addr:)?(([0-9]*\.){3}[0-9]*).*/\2/p'"
alias my-mci="MAVEN_OPTS=\"-Xmx2048m -Xms1024m -Djava.awt.headless=true -XX:+TieredCompilation -XX:TieredStopAtLevel=1\" mvn -T 2 clean install"
alias my-mci-notest="MAVEN_OPTS=\"-Xmx2048m -Xms1024m -Djava.awt.headless=true -XX:+TieredCompilation -XX:TieredStopAtLevel=1\" mvn -T 2 clean install -Dmaven.test.skip -DskipTests"
