...
alias my-generateRandomUUID="cat /proc/sys/kernel/random/uuid"
...
alias my-public-ip="curl -s -H 'Cache-Control: no-cache' https://tools.webisometry.com/my-public-ip && echo"
